...
const inputCls =
    "w-full rounded-xl border border-[#DEE2E8] bg-[#F7F7F5] px-4 py-3.5 text-sm text-[#16233F] outline-none transition-colors duration-300 placeholder:text-[#55606E]/60 focus:border-[#B8912A]";
const labelCls = "mb-2 block text-[11px] uppercase tracking-[0.22em] text-[#55606E]";
        ...
        <section id="quote" className="px-6 py-28 lg:px-12 lg:py-40" data-testid="quote-section">
            <div className="mx-auto grid max-w-[1400px] gap-14 lg:grid-cols-12">
                <div className="lg:col-span-5">
                    <Reveal>
                        ...
                        <h2 className="mt-6 font-serif text-4xl font-medium leading-tight tracking-tight text-[#16233F] sm:text-5xl">
                            Tell us about <span className="italic text-[#B8912A]">your project.</span>
                        </h2>
                        <p className="mt-6 max-w-md text-base leading-relaxed text-[#55606E]">
                    ...
                    <Reveal delay={0.15}>
                        <div className="relative mt-10 overflow-hidden rounded-[1.75rem] border border-[#DEE2E8]">
                            <img
                                src={IMAGES.hinge}
                ...
                <Reveal delay={0.1} className="lg:col-span-7">
                    <div className="rounded-[2rem] border border-[#DEE2E8] bg-white/50 p-8 md:p-12">
                        {status === "sent" ? (
                            <div className="flex h-full flex-col items-start justify-center py-10" data-testid="quote-success">
                                <CheckCircle2 className="h-10 w-10 text-[#B8912A]" />
                                <h3 className="mt-6 font-serif text-3xl font-medium text-[#16233F]">
                                    Enquiry sent.
                                </h3>
                                <p className="mt-4 max-w-sm text-base leading-relaxed text-[#55606E]">
